/**
 * Facet types on {@link ApexPainter}: `detect`, `path2d`, `pixels`, `output`, `createAudio`.
 */
import type { Path2D } from "@napi-rs/canvas";
import type { CanvasResults } from "./canvas";
...
import type { HitRegion, HitDetectionOptions, HitDetectionResult } from "./hit-detection";
import type { PixelData, PixelManipulationOptions } from "./pixels";
import type {
  SynthComposeOptions,
  SynthMixInput,
  SynthMixOptions,
