...
export function resolveApexifyRuntimeConfig(input: ApexifyRuntimeConfigInput = {}): Readonly<ApexifyRuntimeConfig> {
  ...
  cache.maxEntries = finitePositiveInteger("cache.maxEntries", cache.maxEntries);
  cache.maxBytes = finitePositiveInteger("cache.maxBytes", cache.maxBytes);
  ...
  ffmpeg.maxStdoutBytes = finitePositiveInteger("ffmpeg.maxStdoutBytes", ffmpeg.maxStdoutBytes);
  ffmpeg.maxStderrBytes = finitePositiveInteger("ffmpeg.maxStderrBytes", ffmpeg.maxStderrBytes);
